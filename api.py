...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        """Метод делает запрос к API сервера и возвращает статус запроса и результат со списком найденных
        питомцев, совпадающих с фильтром. Также можно получить список уже добавленных с аккаунта животных, если
        передать в filter 'my_pets'"""
